...
<body>
  ...
  <header class="topbar">
    ...
    <nav class="navlinks">
      <a class="active" href="/admins.dashboard">Dashboard</a>
    ...
    <div class="shell">
      <div class="page">
        ...
        <div class="subtitle">Turn your thoughts into posts that pthers can read and enjoy.</div>
        ...
        <div class="stats-row">
          ...
          <div class="stat-card">
            <div class="stat-top">
              <div class="stat-icon">
                <img src="/assets/user.png" alt="Published">
              </div>
